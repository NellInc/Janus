...
/*
 * PcInitializeAdapterDriver — 4 params (per task spec; verify vs DDK)
 * Stores the miniport's AddDevice callback for later invocation.
 */
static NTSTATUS __stdcall pc_InitializeAdapterDriver(
    PVOID DriverObject, PVOID RegistryPath,
    PVOID AddDeviceCallback, PVOID Reserved)
{
...
static const IMPORT_FUNC_ENTRY portcls_funcs[] = {
    ...
    { "PcDispatchIrp",                      (PVOID)pc_DispatchIrp },
